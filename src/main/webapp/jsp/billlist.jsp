...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/sys/queryAllBill">
			<span>商品名称：</span>
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList.getDateList() }" varStatus="status">
				<tr>
					<td>
	...
	<input type="hidden" id="totalPageCount" value="${billList.totalPage}"/>
	<c:import url="rollpage.jsp">
		<c:param name="totalCount" value="${billList.totalRows}"/>
		<c:param name="currentPageNo" value="${billList.currentPageNo}"/>
		<c:param name="totalPageCount" value="${billList.totalPage}"/>
	</c:import>
  </div>
</section>
