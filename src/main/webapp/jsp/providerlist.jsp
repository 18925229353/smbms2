...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/sys/queryAllProvider">
				<span>供应商编码：</span>
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList.getDateList()}" varStatus="status">
				<tr>
					<td>
	...
	<input type="hidden" id="totalPageCount" value="${providerList.totalPage}"/>
	<c:import url="rollpage.jsp">
		<c:param name="totalCount" value="${providerList.totalRows}"/>
		<c:param name="currentPageNo" value="${providerList.currentPageNo}"/>
		<c:param name="totalPageCount" value="${providerList.totalPage}"/>
	</c:import>
    </div>
</section>
