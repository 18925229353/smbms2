...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/sys/queryAllUser">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList.getDateList() }" varStatus="status">
					<tr>
						<td>
						...
						<td>
							<span>${user.smbmsRole.roleName}</span>
						</td>
						<td>
			...
			<input type="hidden" id="totalPageCount" value="${userList.totalPage}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${userList.totalRows}"/>
	          	<c:param name="currentPageNo" value="${userList.currentPageNo}"/>
	          	<c:param name="totalPageCount" value="${userList.totalPage}"/>
          	</c:import>
        </div>
    </section>
